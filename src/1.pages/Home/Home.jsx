...
import { toggleUserId, cartUser} from '../../redux/1.actions';
...
class Home extends Component {
    ...
    renderProducts = () => {
        let jsx = this.state.productData.map(val => {
            return(
                <ProductBox cartJing={this.props.cartUser} idUser={this.props.id} nama={val.nama} harga={val.harga} discount={val.discount} img={val.img} id={val.id} />
            )
        })
        return jsx
    }
